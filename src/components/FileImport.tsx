        ...
        <div className="max-w-xl w-full bg-bg-surface border border-border-main rounded-lg shadow-2xl relative overflow-hidden">
          ...
          <div className="p-12 space-y-8">
            ...
            <button 
              ...
              aria-label="Select File from System"
              className="w-full border border-border-main bg-bg-deep p-16 text-center cursor-pointer transition-all group hover:border-accent-orange/40"
            >
              <input 
                type="file" 
                ref={fileInputRef} 
